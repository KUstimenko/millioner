...
const Questions = ({
  ...
  const getRandomQuestion = useCallback(() => {
    ...
    if (questionNumber <= 5) {
      availableQuestions = data.filter((q) => q.level === "easy" && !q.used);
    } else if (questionNumber <= 10) {
      availableQuestions = data.filter((q) => q.level === "medium" && !q.used);
    } else if (questionNumber <= 15) {
      availableQuestions = data.filter((q) => q.level === "hard" && !q.used);
    }
